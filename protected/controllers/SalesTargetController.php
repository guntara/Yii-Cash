...
class SalesTargetController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['SalesTarget']))
		{
			$model->attributes=$_POST['SalesTarget'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('SalesTarget');
	...
	{
		$model=new SalesTarget('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SalesTarget']))
			$model->attributes=$_GET['SalesTarget'];
	...
	{
		$model=SalesTarget::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='sales-target-form')
		{
