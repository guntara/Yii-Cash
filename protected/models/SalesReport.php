...
class SalesReport extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_SO, id_DO, id_invoice, posting_date, due_date, customer, quantity, uom, teritory, sales_term, total, payment_date, create_at', 'required'),
			...
			array('id, id_SO, id_DO, id_invoice, posting_date, due_date, customer, quantity, uom, teritory, sales_term, total, status, payment_date, create_at', 'safe', 'on'=>'search'),
		);
	}
